...
export class ConnectionsManager {
  ...
  addConnection(sourceId, targetId) {
    ...
    // Bug 3 Fix: Kontrollpunkte einmalig bei addConnection generieren,
    // nicht bei jedem render() – verhindert flackernde Kurven beim Dragging
    const cpOffsetX = Math.random() * 80 - 40;
    const cpOffsetY = Math.random() * 80 - 40;
    this.connections.push({ sourceId, targetId, cpOffsetX, cpOffsetY });
    this.render();
  }
  ...
  render() {
    // Bug 2 Fix: defs sicher sichern, Null-Check, Arrowhead neu erzeugen wenn nötig
    ...
    this.connections.forEach(conn => {
      ...
      // Bug 3 Fix: Gespeicherte stabile Offsets verwenden
